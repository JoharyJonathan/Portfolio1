...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_59jshkk", // Remplacez par votre Service ID EmailJS
        "template_d4844aa", // Remplacez par votre Template ID EmailJS
        formData,
        "jI1s0HJHCOagbPnd3" // Remplacez par votre User ID EmailJS
      )
      .then(
        (response) => {
